  ...
  return (
    ...
    >
      ...
      >
        ...
        <Change
            header="Release 3.5.0 - October 5th, 2025"
            features={[
              "Updated yt-dlp backend"
            ]}
          />
        <Change
            header="Release 3.4.9 - July 6th, 2025"
            features={[
              "Increased RAM allocation for backend machines"
            ]}
          />
        <Change
            header="Release 3.4.8 - July 2nd, 2025"
            features={[
              "Updated yt-dlp backend"
            ]}
          />
        <Change
          ...
          />
          <Change
            header="Release 3.4.4 - January 14th, 2025"
            features={["Updated yt-dlp backend"]}
          />
          <Change
          ...
          />
          <Change
            header="Release 3.4.1 - September 6th, 2024"
            features={[
              "Fixed YouTube blocking issues again",
              "Tweaked the download preview so that users don't accidentally select the preview",
            ]}
          />
          <Change
          ...
          />
          <Change
            header="Release 3.2.9 - July 19th, 2024"
            features={["Updated yt-dlp library in backend again"]}
          />
          <Change
            header="Release 3.2.8 - July 9th, 2024"
            features={[
              "Updated yt-dlp library in backend, which fixed issues with YouTube extractor",
            ]}
          />
          <Change
            header="Release 3.2.7 - July 2nd, 2024"
            features={[
              "Expanded backend to handle more requests and evade YouTube blocking",
            ]}
          />
          <Change
            header="Release 3.2.6 - June 19th, 2024"
            features={["Another fix attempt for YouTube blocking issue"]}
          />
          <Change
            header="Release 3.2.5 - June 15th, 2024"
            features={[
              "Attempted fix for YouTube blocking issue, may or may not work",
            ]}
          />
          <Change
          ...
          <Change
            ...
            features={[
              ...
              "Updated the FAQ to note that SoundCloud and BandCamp only support 128kbps quality",
            ]}
          />
          <Change

...
function NavMenu(props) {
  return (
    <NavigationMenu className="absolute top-16 scale-[80%] rounded-3xl border-[2px] border-[#9b96a7] bg-gradient-to-b from-nav_top to-nav_bot px-2 py-1 font-medium backdrop-blur-sm min-[425px]:scale-[90%] min-[540px]:scale-100">
